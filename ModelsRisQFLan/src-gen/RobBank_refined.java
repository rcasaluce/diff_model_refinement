...
public class RobBank_refined implements IAtreeModelBuilder {
	
	public RobBank_refined(){
	...
	public AtreeModel createModel(){
		...
		NormalAction goBack = new NormalAction("goBack");
		model.addNormalAction(goBack);
		...
		TryLearnCombo.addTransition(new ProcessTransition(5.0,tryAction,TryFindCode,new SideEffect[]{},new BooleanConstraintExpr(new BooleanConstraintExpr(new NotConstraintExpr(new HasNodeConstraint(FindCode1)),new NotConstraintExpr(new HasNodeConstraint(FindCode2)),BooleanConnector.OR),new NotConstraintExpr(new HasNodeConstraint(FindCode3)),BooleanConnector.OR)));
		...
		TryFindCode.addTransition(new ProcessTransition(0.001,goBack,TryLearnCombo,new SideEffect[]{},new TrueConstraint()));
		...
		TryBlowUp.addTransition(new ProcessTransition(0.001,goBack,Start,new SideEffect[]{},new TrueConstraint()));
